...
@BeforeEach
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    GetRestaurantsResponse allRestaurantsCloseByOffPeakHours=new GetRestaurantsResponse(restaurantList1);
    GetRestaurantsResponse allRestaurantsCloseByPeakHours=new GetRestaurantsResponse(restaurantList2);
